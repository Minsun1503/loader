...
try {
    ...
    console.log('Class converted:', cls.prototype.className);
    
    // Look at all methods
    console.log('--- METHODS IN hso_ap ---');
    for (let key in cls.prototype) {
        ...
        if (item && item.data) {
            ...
            if (hasPutfield) {
                console.log(`Method ${key} initializes or writes to $a__I!`);
            }
        }
    }
