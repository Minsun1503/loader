	...
	function readAttributes(name, type, accessFlags) {
		...
		for (var i = 0; i < count; i++) {
			...
			if (attributeName == 'StackMap' || attributeName == 'LineNumberTable' || attributeName == 'SourceFile' ||
				attributeName == 'LocalVariableTable' || attributeName == 'StackMapTable' ||
				attributeName == 'Signature' || attributeName == 'RuntimeVisibleAnnotations' ||
				attributeName == 'RuntimeInvisibleAnnotations' || attributeName == 'Deprecated' ||
				attributeName == 'BootstrapMethods' || attributeName == 'MethodParameters' ||
				attributeName == 'EnclosingMethod' || attributeName == 'LocalVariableTypeTable' ||
				attributeName == 'AnnotationDefault' || attributeName == 'RuntimeVisibleParameterAnnotations' ||
				attributeName == 'RuntimeInvisibleParameterAnnotations' || attributeName == 'RuntimeVisibleTypeAnnotations' ||
