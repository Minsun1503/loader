(function () {    
	...
	window.onload = function () {
		...
		settingsDialog.querySelector('button.done').addEventListener('click', function () {
		...
		if (js2me.config.src) {
			...
			request.open('GET', js2me.config.src + (js2me.config.src.indexOf('?') !== -1 ? '&' : '?') + 'v=' + new Date().getTime());
