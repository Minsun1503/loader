js2me.createClass({
	...
	$indexOf$Ljava_lang_Object_$I: function (obj) {
		return this.$indexOf$Ljava_lang_Object_I$I(obj, 0);
	},
	/*
	 * public int indexOf(Object elem, int index)
	 */
	$indexOf$Ljava_lang_Object_I$I: function (obj, index) {
		for (var i = index; i < this.array.length; i++) {
			if (obj == null ? this.array[i] == null : (this.array[i] != null && this.array[i].$equals$Ljava_lang_Object_$Z(obj))) {
				return i;
			}
		}
		return -1;
